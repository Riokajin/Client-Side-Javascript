...
let person = {
    ...
    age: 35,
    gender: "Male",
    interests: ["Gaming", "Cycling", "Programming", "Reading", "Swimming", "Climbing"],
    greetings: function(){
        // Hey, this is Adam Evans
        alert(`Hey this is ${this.name.firstName} ${this.name.lastName}`)
    },
    bio: function(){
        // The interests of Adam Evans, of age: 16, of gender: Male, are Gaming, Cycling, Reading, Swimming, Climbing
        return `The interests of ${this.name.firstName} ${this.name.lastName}, of age ${this.age}, are ${this.interests.join(", ")}.`
    }
}
=======
...
let person1 = {
    name: "Person1",
    hello: function(){
        return `Hey this is ${person2.name}.`
    }
}
let person2 = {
    name: "Person2",
