...
class Coffee {
    ...
    serveIt() {
        // Implementation for serving the coffee
    ...
    cup.setAttribute("title", `A ${this.size} ${this.isDecaf ? "decaffeinated" : "caffeinated"} Coffee`,
...
let priyanshLatte = new Latte("medium", false, "whole");
